...
return (
    ...
    <div  className='inputDiv'>
        ...
        onChange={handleChange} id='email' placeholder='Mail adresinizi giriniz' 
        className={errors.email ? 'input-error':''}/>
        {errors.email && <p className='error'>{errors.email}</p>}
    </div>
    <div className='inputDiv'>
        <label>Yaş</label>
        <input type='number' value={values.age}
        onChange={handleChange} id='age' placeholder='Yaşınızı giriniz'
    ...
    <div  className='inputDiv'>
        ...
        onChange={handleChange} id='password' placeholder='Şifrenizi giriniz' 
    ...
    <div  className='inputDiv'>
        ...
        onChange={handleChange} id='confirmPassword' placeholder='Şifrenizi tekrar giriniz'
